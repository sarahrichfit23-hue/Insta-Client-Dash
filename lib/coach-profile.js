...
export function buildCoachProfilePrompt(profile) {
  ...
  // Handle delivery method as array or string
  ...
  const delivery = profile.lead_magnet_delivery
  ...
  // Handle sales method as array or string
  ...
  const sales = profile.offer_sales_method
